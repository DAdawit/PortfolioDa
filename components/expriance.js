            ...
            <div className={styles.lists}>
              <ul>
                <li className={styles.flex}>
                  ...
                  responsible to develop an attractive user interface using
                  Vuejs and vuetify.
                </li>
                <li className={styles.flex}>
                  <span className="material-icons icons">star_border</span>
            ...
            <div className={styles.lists}>
              <ul>
                <li className={styles.flex}>
                  ...
                  devices, furniture, and stationery material and the system has
                  its own simulation banking system for payment.
                </li>
                <li className={styles.flex}>
                  <span className="material-icons icons">star_border</span>
